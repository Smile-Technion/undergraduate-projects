...
class DDPG(OffPolicyRLModel):
    ...
    """
    #LEARNING RATES x 3. exploration 0.3 actor_lr=2e-4, critic_lr=2e-3
    def __init__(self, policy, env, gamma=0.99, memory_policy=None, eval_env=None, nb_train_steps=50,
                 ...
                 return_range=(-np.inf, np.inf), actor_lr=2e-4, critic_lr=2e-3, clip_norm=None, reward_scale=1.,
                 render=False, render_eval=False, memory_limit=None, buffer_size=50000, random_exploration=0.2,
